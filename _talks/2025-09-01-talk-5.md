...
- Injected trainable low-rank matrices (**ΔW = BA**) into attention projection layers
...
**W_final = α × W_finetuned + (1 - α) × W_pretrained**

where α ∈ [0, 1] is the interpolation coefficient.

**Implementation:**
- Explored interpolation coefficient α ∈ [0, 1] with grid search
...
- Interpolating with **α ∈ [0.2–0.4]** gave best balance between in-domain and out-of-domain performance
...
- The optimal α varies by task and distribution shift severity
